  ...
  return (
    ...
    >
      <header className="flex h-14 items-center gap-6 border-b border-shot-line bg-shot-panel px-8">
        <span className="text-[15px] font-semibold tracking-tight text-shot-ink">
          {session.site}
        </span>
        ...
        <span className="text-[13px] text-shot-ink">{t('basket_2')}</span>
      </header>
        ...
        <main>
          {state.confirmed ? (
            ...
            <>
              ...
              <p className="mt-1 text-[13px] text-shot-text">{t('guest_no_account_needed')}</p>
