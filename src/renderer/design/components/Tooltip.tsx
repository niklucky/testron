...
export const Tooltip = ({
  ...
  <span className={`group relative ${className}`}>
    ...
    <span
      role="tooltip"
      className={`pointer-events-none absolute bottom-full z-20 mb-1.5 hidden whitespace-nowrap rounded-md border border-line bg-plane px-2 py-1 text-xs text-ink-2 shadow-lg group-hover:block ${
